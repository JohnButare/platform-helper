...
hagermanFileServers="file2.$hagermanBaseDomain,file1.$hagermanBaseDomain"		# File Servers
hagermanLbServers="pi1,pi2,pi3,pi4"																					# Load Balancer Servers (NGINX reverse proxy)
hagermanNas="nas3.$hagermanDomain"																					# NAS Server
hagermanProxyServers="proxy.$hagermanBaseDomain:3128" 											# Forward Proxy Servers
hagermanVip="10.10.100.6" 																									# Virtual IP Address
hagermanWireguardServers="pi2.$hagermanBaseDomain,pi1.$hagermanBaseDomain" 	# Wireguard VPN Servers